 ...
 */
//eigener Deskriptor #define USB_CFG_INTR_POLL_INTERVAL      10
/* If you compile a version with endpoint 1 (interrupt-in), this is the poll
 * interval. The value is in milliseconds and must not be less than 10 ms for
 * low speed devices.
 */
//eigener Deskriptor #define USB_CFG_IS_SELF_POWERED         0
/* Define this to 1 if the device has its own power supply. Set it to 0 if the
 * device is powered from the USB bus.
 */
//eigener Deskriptor #define USB_CFG_MAX_BUS_POWER           100
 ...
 */
#define USB_CFG_DEVICE_ID   0xB3, 0x06
 ...
 *** Eigene Voti-USB-ID ***
 */
#define USB_CFG_DEVICE_VERSION  0x20, 0x46
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME	'U','S','B','2','L','P','T',' ',\
				'l','o','w','-','s','p','e','e','d',' ',\
				'a','d','a','p','t','e','r'
#define USB_CFG_DEVICE_NAME_LEN 25
 ...
 */
//own descriptor #define USB_CFG_INTERFACE_CLASS     0
//own descriptor #define USB_CFG_INTERFACE_SUBCLASS  0
//own descriptor #define USB_CFG_INTERFACE_PROTOCOL  0
...
#define USB_CFG_DESCR_PROPS_CONFIGURATION           USB_PROP_LENGTH(55)
 ...
 */
#ifdef PCINT0_vect
// ATmegaX8 uses (power-saving) pin-change interrupt for ISR and wakeup
#define USB_INTR_CFG		PCMSK0
#define USB_INTR_CFG_SET	0x01
#define USB_INTR_CFG_CLR	0x00
...
#else
// ATmega8 uses input capture interrupt for ISR and watchdog polling for wakeup
